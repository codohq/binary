...
class ArtisanCommand extends Command implements Eligible
{
  /**
   ...
   * @var string
   */
  protected $signature = 'artisan {--c|--container=php} {--w|--workdir=}';
  ...
  public function handle()
  {
    ...
    return $this->binary->dockerCompose($container, "php ./artisan {$command}", $workdir);
  }
}
